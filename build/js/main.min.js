...
var _slid = require("./modules/slid");
// ---------------------------------
...
},{"./modules/form-validate/form":3,"./modules/slid":9,"./modules/tabs/index":10,"./modules/video/video":13,"./utils/ios-vh-fix":15}],2:[function(require,module,exports){
"use strict";
...
exports.initTwoSwiper = exports.initSwiper = void 0;
var slid = document.querySelector('.coaches__swiper');
var reviewsSlid = document.querySelector('.reviews__swiper');
...
var initTwoSwiper = function initTwoSwiper() {
  if (reviewsSlid) {
    (function () {
...
exports.initTwoSwiper = initTwoSwiper;
...
},{"./init-tabs":11}],11:[function(require,module,exports){
"use strict";
...
var initVideo = function initVideo() {
  var video = document.querySelectorAll('.gym__video-wrapper');
  var iframe = document.querySelectorAll('.gym__video');
  if (video && video.length) {
    video.forEach(function (block) {
      var videoCover = block.querySelector('.gym__video-cover');
      var videoButton = block.querySelector('.gym__video-button');
      var iframeBlock = block.querySelector('.gym__video');
