...
},{"./modules/form-validate/form":3,"./modules/sliders":9,"./modules/tabs/index":10,"./modules/video/video":13,"./utils/ios-vh-fix":15}],2:[function(require,module,exports){
"use strict";
...
var initSliders = function initSliders() {
  sliders.forEach(function (_ref) {
    ...
    var observeSlide = function observeSlide(entry) {
    ...
    var observer = new IntersectionObserver(function (entries) {
      return entries.forEach(observeSlide);
    }, {
      root: container
    });
    container.querySelectorAll('[data-swiper-slide-index]').forEach(function (slide) {
...
var initVideo = function initVideo() {
  ...
  video.forEach(function (block) {
    ...
    videoButton.addEventListener('click', function () {
      iframeBlock.src = "".concat(iframeBlock.src, "?autoplay=1");
